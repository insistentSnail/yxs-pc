      ...
      <div class="classInfo-c">
        ...
        <div class="content">
          ...
          <div class="content-r">
            ...
            <div class="classNum">共{{ info.lessonNum }}个课时</div>
            <div class="priceBox">
            ...
            <div class="applyNum">{{ info.actualLearnNum }}人报名</div>
            <div class="btnBox">
              <div class="ljbm" v-if="info.price != 0">
                {{ info.bugFlag == 0 ? "立即购买" : "您已购买" }}
              </div>
              ...
              <div
                class="mfst"
                v-if="info.bugFlag == 0 && info.price != 0"
                @click="freeJoin"
              >
                免费试听
              </div>
    ...
    <div class="classContent">
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="课程详情" name="first" class="bjxq">
          ...
          <p>
            有机化学又称为碳化合物的化学，是研究有机化合物的组成、结构、性质、制备方法与应用的科学，是化学中极重要的一个分支。
            含碳化合物被称为有机化合物是因为以往的化学家们认为含碳物质一定要由生物（有机体）才能制造。
          </p> -->
          <div v-html="info.about"></div>
        </el-tab-pane>
        <el-tab-pane label="课程目录" name="second" class="kcjs">
              ...
              <swiper-slide v-for="(item, index) in swiperLists" :key="index">
                ...
                >
                  <div class="classItem-t">
                    <img src="@/assets/images/class/classItem.png" alt="" />
                  </div>
                ...
                >
                  <div class="child-l">
                    <img
                      ...
                      alt=""
                    />
                    <span :class="videoIndex == ele.id ? 'blue' : 'normal'">{{
                      ele.title
                    }}</span>
                  </div>
                  <div class="child-r">
      ...
      <div class="videoBox">
        <div class="videoBox-c">
          ...
          <div class="video-content">
            <!-- <video id="avideo" ref="video" controls="controls" :src="videoSrc">
              您的浏览器不支持 video 标签。
            </video> -->
            <!-- 渠道logo -->
            <div class="logo">
...
export default {
  ...
  methods: {
    ...
    initCourse() {
      getCourseDetail({ courseId: this.$route.params.id }).then(res => {
        this.info = res.data;
      });
    },
    ...
    videoSrc(ele, callback) {
      ...
      console.log(this.lastId, "this.lastId", this.lessonId, "this.lessonId");
